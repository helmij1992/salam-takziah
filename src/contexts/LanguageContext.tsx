...
const translations: Record<Language, Translations> = {
  ms: {
    ...
    freeTierNoticeDescription: "Pelan Free dihadkan kepada 5 poster sebulan, format Classic dan Instagram Story, medan asas, dan muat turun bertanda air.",
  ...
  en: {
    ...
    freeTierNoticeDescription: "The Free plan is limited to 5 posters per month, Classic and Instagram Story formats, basic fields, and watermarked downloads.",
